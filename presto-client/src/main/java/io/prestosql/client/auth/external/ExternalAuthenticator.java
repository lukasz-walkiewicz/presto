...
import static io.prestosql.client.auth.external.AuthenticationAssembler.toAuthentication;
        ...
        implements Authenticator, Interceptor
{
    ...
    public Request authenticate(Route route, Response response)
    {
        ...
        obtainedToken.ifPresent(this::setKnownToken);
    ...
    private void setKnownToken(AuthenticationToken token)
    {
